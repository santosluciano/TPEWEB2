<?php
  class CelularesView extends View
  {
    ...
    function errorFormCelular($error,$nombre, $caracteristicas,$precio,$marcas,$id_marca_celular,$action,$accion,$encabezado){
    ...
    function mostrarActualizarCelular($nombre,$caracteristicas,$precio,$id_celular,$id_marca,$marcas){
      $this->assignarForm($nombre,$caracteristicas,$precio);
      $this->smarty->assign('marcas',$marcas);
